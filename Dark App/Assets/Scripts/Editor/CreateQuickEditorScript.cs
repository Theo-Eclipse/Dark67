...
public class CreateQuickEditorScript : MonoBehaviour
{
    ...
    private static readonly string LowerCaseScriptNameFilter = "$$LowerCaseScriptName$$";
    ...
    private static string lowerCaseScriptName = "";
    ...
    private static void CreateEditorScriptForScript()
    {
        ...
        lowerCaseScriptName = scriptName.ToLower();
        ...
        readenfile = readenfile.Replace(LowerCaseScriptNameFilter, lowerCaseScriptName);
